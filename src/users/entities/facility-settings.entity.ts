...
export class FacilitySettings {
  ...
  @Column({ type: 'varchar', length: 100, nullable: true, name: 'support_phone' })
  supportPhone: string;

  @Column({ type: 'varchar', length: 150, nullable: true, name: 'support_email' })
  supportEmail: string;
  ...
  @Column({ type: 'varchar', length: 200, nullable: true, name: 'custom_css_url' })
  customCssUrl: string;
  ...
  // ── Kiosk config ─────────────────────────────────────────
  @Column({ type: 'varchar', length: 10, default: 'en', name: 'default_language' })
